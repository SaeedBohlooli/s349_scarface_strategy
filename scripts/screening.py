...
def calculate_number_of_contracts(ask):
    ...
    #  num_of_contracts: 4
    logger.info(f"calculate_number_of_contracts(), {symbol}, capital: {capital}, capital_per_trade_percentage: {capital_per_trade_percentage}, max_num_open_trades: {max_num_open_trades}")
...
if __name__ == "__main__":
    ...
    while True:
      try:
        ...
        busy_time = eval(app_config.get('busy_time', '1 == 2'))
        ...
        # if not busy_time and 930 < current_hh_mm_ny < 932 and app_config.get('user_name','') == 'saeed' and checkmark_map.get('TEST_STRIKES'):
        #     test_get_bid_ask_for_symbols()
        #     checkmark_map['TEST_STRIKES'] = True
        ...
        for symbol in app_config['symbols']:
            ...
            if not busy_time and 931 < current_hh_mm_ny and not checkmark_map.get(f'{symbol}-MARK_GAP') :
        ...
        # in the WHILE TRUE...
        if (not busy_time ) and ( 5 * run_number % 60 * 2 == 0):
            save_all_csv_files()
